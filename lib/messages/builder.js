...
function builder(options) {
  ...
  if (!options.network) {
    options.network = zipcore.Networks.defaultNetwork;
  }

  options.Block = options.Block || zipcore.Block;
  options.BlockHeader = options.BlockHeader || zipcore.BlockHeader;
  options.Transaction = options.Transaction || zipcore.Transaction;
  options.MerkleBlock = options.MerkleBlock || zipcore.MerkleBlock;
  options.MnListDiff = options.MnListDiff || zipcore.MnListDiff;
